  ...
  private handleAuthError(error: auth.Error): Promise<string> {
    ...
    switch (error.code) {
      ...
      case 'auth/invalid-email':
        errorMessage = 'Verilen e-posta geçerli değil.';
        break;
      ...
      case 'auth/network-request-failed':
        errorMessage = 'Zayıf bağlantı. Lütfen tekrar deneyin.';
        break;
      case 'auth/popup-blocked':
        errorMessage = 'Açılır pencere tarayıcınız tarafından engellendi.';
        break;
